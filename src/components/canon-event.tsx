...
const OnboardingBear = ({ onStart, onComplete }: { onStart: () => void, onComplete: () => void }) => {
    ...
    const steps = [
        ...
        {
            text: "Perfect! Now, let's use the dock at the bottom to navigate to the 'Soft Side of You' section.",
...
// --- Dock Navigation ---
const Dock = ({ navItems }: { navItems: Array<{ id: string; title: string; icon: React.ElementType }> }) => (
...
const MainContent = ({ showPixelTrail, setShowPixelTrail }: { showPixelTrail: boolean, setShowPixelTrail: (show: boolean) => void }) => {
    ...
    return (
        <div className="bg-background text-foreground min-h-screen">
            <main className="text-center divide-y-2 divide-secondary pb-24">
